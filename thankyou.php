<?php include 'thank-you-header.php';?>




<div class=" service-main-section page-banner thankyou-messege ">
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-9 m-auto text-center">
            <div class="main-heading thankyou-screen">
                <!-- <p class="main-mini-heading">ABOUT US</p> -->
               <h1 class="">Thank You for<span class="italic-font"> Booking Your Meeting!</span> </h1>
               <p> We've received your booking and can't wait to connect!
               </p>
               <ol>
                <li> <p> Confirmation email on the way. </p></li>
   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-6 col-md-6 col-12">
            ...
            <div class="row">
               <div class="col-lg-5 col-md-6 col-sm-4 col-12">
                  <div class="single-footer-items">
                     <p class="footer-servies-heading"> Creative design services</p>
                     <ul class="menu-list">
                        <li><a href="#">Video Editing</a></li>
                        <li><a href="#">Motion Design</a></li>
                        <li><a href="#">Social Media Creative </a></li>
                        <li><a href="#">Graphic Design</a></li>
                        <li><a href="#">Ad Creative</a></li>
               ...
               <div class="col-lg-3 col-md-6 col-sm-4 col-12">
                  <div class="single-footer-items pl-5">
                     <p class="footer-servies-heading">AI Services</p>
                     <ul class="menu-list">
                        <li><a href="index.html">AI Enhance Creative </a></li>
                        <li><a href="about.html">AI Consulting</a></li>
                     </ul>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-4 col-12">
                  <div class="single-footer-items pl-5">
                     <p class="footer-servies-heading">Marketing Services</p>
                     <ul class="menu-list">
                        <li><a href="index.html">Marketing Strategy </a></li>
                        <li><a href="about.html">Google Ads</a></li>
                        <li><a href="about.html">Facebook Ads</a></li>
                     </ul>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-4 col-12">
               <div class="single-footer-items">
                  <p class="footer-servies-heading">Main</p>
                  <ul class="menu-list">
            ...
            <div class="col-lg-6 col-md-6  col-sm-6 col-12">
               <div class="single-footer-items pl-5">
                  <p class="footer-servies-heading">Learn</p>
                  <ul class="menu-list">
                     <li><a href="index.html">Blog</a></li>
                     <li><a href="about.html">Events & Summits</a></li>
                     <li><a href="about.html">Guides & Reports</a></li>
                     <li><a href="about.html">Customer Stories</a></li>
                     <li><a href="about.html">Video Library</a></li>
                     <li><a href="about.html">Playbooks</a></li>
      ...
      <form id="demoForm">
         <div class="form-container">
            <div class="form-filed-width">
               ...
               <div id="step4" class="input-container" style="display: none;">
                  <textarea id="notes" placeholder="Your Message/Notes" rows="3" style="width: 100%; padding: 10px; border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 5px; background: transparent; color: #fff; font-family: 'Sora', sans-serif; resize: none;"></textarea>
               </div>
            </div>
...
<script>
   ...
   // Add event listener to restrict phone input to numbers only
   ...
   async function saveToSupabase(userData) {
       try {
           const { data, error } = await supabaseClient
               .from('Users')  // Using the Users table from Supabase
               .insert([userData]);
   ...
   function sendEmailNotification(userData) {
       const templateParams = {
           to_email: 'mridul@scalerstudios.com',
           name: userData.name,
...
Submitted At: ${userData.created_at}
           `
       };
   ...
   function updateProgressBar() {
       let progress = 0;
       if (currentStep === 1) progress = 25;
       else if (currentStep === 2) progress = 50;
       else if (currentStep === 3) progress = 75;
       else if (currentStep === 4) progress = 100;
...
<!-- <script>
    $(window).on('scroll', function() {
      if ($(this).scrollTop() > 1) {
        $('.mobile-header-main').addClass('sticky');
      } else {
        $('.mobile-header-main').removeClass('sticky');
      }
    });
  </script> -->

  <script>
    if ($(".mobile-header-main").length > 0) {
      $(window).on("scroll", function () {
