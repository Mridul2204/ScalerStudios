...
<body>
  ...
  <nav class="nav-wrap">
    <div class="nav-inner">
      <a href="#" class="nav-logo">
        <img src="img/green-logo.png" alt="Scaler Studios">
      </a>
      <ul class="nav-links">
        <li><a href="#ch1">Volume Trap</a></li>
        <li><a href="#ch2">Brand Blindness</a></li>
        <li><a href="#ch3">Human Gap</a></li>
        <li><a href="#ch4">Strategy Deficit</a></li>
        <li><a href="#ch5">Measurement Void</a></li>
      </ul>
      <div class="d-flex justify-content-end">
      <a href="https://www.scalerstudios.com/" class="nav-cta" target="_blank">Work With Us</a>
    </div>
    </div>
  </nav>
    ...
    <div class="hero-inner">
      ...
      <div class="hero-visual">
        <div class="hero-img-wrap">
          <img src="img/ai1.jpg" alt="AI Marketing">
        </div>
  ...
  <section class="chapter chapter1" id="ch1">
    ...
    <div class="chapter-media">
      <div class="chapter-image chapter-media-box">
    ...
    <div class="chapter-one-content chapter-q">
      <div class="row">
        <div class="col-lg-6">
          <div class="fix-box-1">
            <h4>
  ...
  <section class="chapter-two" id="ch2">
  ...
  <section class="chapter chapter-two p-0" id="ch3">
    <div class="chapter-media mb-0">
  ...
  <!-- CHAPTER THREE -->
  <section class="chapter chapter-three">
    <div class="container-fluid">
  ...
  <!-- BOOK AREA -->
  <div class="book-wrapper chapter-four chapter">
    <div class="book">
      ...
      <section class="book-section">
        <div class="content">
          <div class="chaptar-four-main-img">
            <img src="img/ai2.jpg" alt="">
          </div>
          <div class="four-banner-content">
            <div class="chapter-media mb-0">
      ...
      <section class="book-section">
        <div class="content">
          <div class="book-four book-four-three">
            <div class="chapter-one-content chapter-q border-0">
              <div class="row">
                <div class="col-lg-12">
                  <div class="fix-box-1">
                    <h4>
  ...
  <section class="chapter-five chapter-two">

    
      <div class="five-horizontal-wrapper">
        <div class="five-horizontal-sticky">
          <div class="five-horizontal-container">
            <div class="panel">
              <div class="chapter-media">
              <div class="chapter-content chapter-media-box">
                <div class="">
    ...
    <div class="conclusion-inner">
      ...
      <div class="takeaways">
        <div class="takeaway">
          ...
          <p>Volume without strategy wastes budget. Define the goal, the audience, and the emotion before you touch any
            AI tool.</p>
        </div>
        <div class="takeaway">
          <span class="num">02</span>
          <strong>Feed AI your brand</strong>
          <p>Brand identity must live inside your AI workflow. Build a brand context doc and use it every time  or your
            creative will look like everyone else's.</p>
        </div>
        <div class="takeaway">
          <span class="num">03</span>
          <strong>Protect the human layer</strong>
          <p>Strategy, emotional judgment, and creative direction are yours. AI handles execution. Blur that line and
            performance suffers.</p>
        </div>
        <div class="takeaway">
          <span class="num">04</span>
          <strong>Think before you build</strong>
          <p>The strategic memo comes before the prompt. Position clearly, understand your audience deeply, then let AI
            execute at speed.</p>
        </div>
        <div class="takeaway">
          <span class="num">05</span>
          <strong>Test to learn, not just to ship</strong>
  ...
  <section class="cta">
    ...
    <a href="https://www.scalerstudios.com/" class="cta-btn" target="_blank">Let's Work Together ?</a>
  ...
  <footer>
    <span class="logo">Scaler Studios.  Get Your AI Together. 2025</span>
    <span class="copy"> 2025 Scaler Studios. All rights reserved.</span>
  </footer>
 ...
 <script>
  const fivehorizontal = document.querySelector('.five-horizontal-container');
  const fivehwrapper = document.querySelector('.five-horizontal-wrapper');
  
  const fivespeedMultiplier = 1;
  
  function setWrapperHeight() {
    if (window.matchMedia("(max-width: 768px)").matches) {
      hwrapper.style.height = "auto";
      return;
    }
  
    const maxScroll = Math.max(0, fivehorizontal.scrollWidth - window.innerWidth);
    fivehwrapper.style.height = `${window.innerHeight + maxScroll}px`;
  }
  ...
  function onScroll() {
    ...
    const offsetTop = fivehwrapper.offsetTop;
    const height = fivehwrapper.offsetHeight - window.innerHeight;
  
    const maxScroll = Math.max(0, fivehorizontal.scrollWidth - window.innerWidth);
  
    if (scrollTop <= offsetTop) {
      fivehorizontal.style.transform = "translateX(0px)";
      return;
    }
  
    if (scrollTop >= offsetTop + height) {
      fivehorizontal.style.transform = `translateX(-${maxScroll}px)`;
      return;
    }
  
    const progress = height > 0 ? (scrollTop - offsetTop) / height : 0;
    const nextX = progress * maxScroll * fivespeedMultiplier;
    const clampedX = Math.max(0, Math.min(maxScroll, nextX));
  
    fivehorizontal.style.transform = `translateX(-${clampedX}px)`;
  }
  ...
  <script>
    ...
    window.addEventListener("scroll", () => {
      ...
      sections.forEach((section, i) => {
        ...
        const start = i * h;
        let progress = clamp((scrollTop - start) / h, 0, 1);
        ...
        section.style.transform =
          `rotateY(${rotateY}deg) scale(${scale}) translateY(${-lift}px)`;

        section.style.zIndex = totalPages - i;
        section.style.setProperty("--curl", progress);
  ...
  <script>
    ...
    const speedMultiplier = 1;    // keep 1 for predictable distance
    ...
    function setWrapperHeight() {
      ...
      const maxScroll = Math.max(0, horizontal.scrollWidth - window.innerWidth);
      wrapper.style.height = `${window.innerHeight + maxScroll}px`;
    }

    function onScroll() {
      const scrollTop = window.scrollY;
      const offsetTop = hwrapper.offsetTop;
      const height = hwrapper.offsetHeight - window.innerHeight;
      ...
      if (scrollTop >= offsetTop + height) {
        horizontal.style.transform = `translateX(-${maxScroll}px)`;
        return;
      }

      const progress = height > 0 ? (scrollTop - offsetTop) / height : 0;
      const nextX = progress * maxScroll * speedMultiplier;
      const clampedX = Math.max(0, Math.min(maxScroll, nextX));
      horizontal.style.transform = `translateX(-${clampedX}px)`;
    }

    function animate() {
      currentX += (targetX - currentX) * smoothness;
      horizontal.style.transform = `translateX(-${currentX}px)`;
    ...
    window.addEventListener("load", () => {
      ...
      const imgs = hwrapper.querySelectorAll("img");
      if (imgs.length) {
        let pending = imgs.length;
        imgs.forEach((img) => {
          if (img.complete) {
            pending -= 1;
            if (pending === 0) refreshLayout();
          } else {
